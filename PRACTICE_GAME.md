...
Syllables are loaded from a custom tokenized embedded copy of `generated_regexes.json` inside `static/practice.html`, then enumerated from each regex pattern into concrete syllables.
